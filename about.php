...
<html class="frontend">
    ...
    <body>
        ...
        <section id="main" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-header text-center">
                                <h1 class="section-title font-alt mb25">ABOUT</h1>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3">
                                    <h4 class="thin text-muted text-center">
                                        Information technology is growing very fast along with human needs are also growing.
                                        Similarly, the creative industries such as handicrafts from bottles used now considered by the craftsmen.
                                        Handmade's is a place where you can find beautiful lamps that come from used bottles that have been processed in a way that is not only beautiful and also useful for everyday life.
                                    </h4>
                                    <blockquote class="mb0">
                                        <p>3 reasons to buy handmade are handmade is made with love, handmades is made with care, handmade is made just for you. </p>
                                        <footer>Emmaline Bride in<cite title="Source Title">Pinterest</cite></footer>
                                    </blockquote>
                                </div>
                            </div>
                        </div>
            ...
            <section class="section jumbotron jumbotron-bg nm" data-stellar-background-ratio="0.4">
                <div class="pb35">
                    <!-- pattern + overlay -->
                    <div class="overlay pattern pattern13"></div>
                    <!-- pattern + overlay -->
                    ...
                    <div class="container">
                                ...
                                <div class="section-header no-border text-center">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            <h4 class="thin text-muted text-center">Some of our satisfied customers review</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <?php
                                $query = mysqli_query($koneksi, "SELECT * FROM tb_inbox ORDER BY id_inbox DESC LIMIT 5");
                                $no = 1;
                            ...
                            ?>
                                ...
                                <div class="item text-center pt5">
                                    <blockquote class="nm">
                                        ...
                                        <footer class="text-white"><?php echo $data['nama_inbox']; ?></footer>
                                    </blockquote>
                                </div>
                                <!--/ review #1 -->
                                <?php
