                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3">
                                    <form class="panel no-border mb0" name="form-login" action="" method="POST" data-parsley-validate>
                                        ...
                                        <?php
                                            ...
                                            if(isset($_POST['submit'])){
                                                ...
                                                $query = mysqli_query($koneksi, "INSERT INTO tb_member values ('','$name','$email','$pass','$address','$zip','$phone','$date') ");

                                                if ($query){
                                                echo '<div class="alert alert-success" role="alert">The data was successfully added.</div>'; 
                                                ?>
                                                <script type="text/javascript">
                                                    setTimeout("location.href='page-login.php'", 400);
                                                </script>
                                                <?php
                                                }
                                            }
                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="has-icon pull-left">
                                                    <input type="text" class="form-control" name="name" data-parsley-required autofocus>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="has-icon pull-left">
                                                    <input type="text" class="form-control" name="address" data-parsley-required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="has-icon pull-left">
                                                    <input type="text" class="form-control" name="zip" data-parsley-required>
                                                    <i class="ico-tag2 form-control-icon"></i>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Phone</label>
                                                <div class="has-icon pull-left">
                                                    <input type="text" class="form-control" name="phone" data-parsley-required>
                                            ...
                                            <div class="form-group">
                                                <div class="checkbox custom-checkbox">  
                                                    ...
                                                    <label for="agree">&nbsp;&nbsp;I agree to the <a class="semibold" href="#">Term Of Services</a></label>   
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <input type="submit" class="form-control btn btn-block btn-primary" name="submit" value="Submit">
                                            </div>
                                        </div>
                                    </form>
                                </div>
            ...
            <div class="container mb25">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <form role="form" name="sendmessage" action="" method="POST" data-parsley-validate>
