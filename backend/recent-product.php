                                ...
                                <div class="col-md-3 col-xs-6">
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body text-center" style="margin-top:-50px;">
                                            <img class="img-bordered" src="../img/<?php echo $data['gbr_produk']; ?>" alt="" width="200px" height="250px">
                                            <h3 class="text-center text-primary semibold mb0">IDR <?php echo $data['harga_produk'];?></h3>
                                        </div>
                                        <!--/ panel body -->
                                        <!-- table -->
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td width="20%" align="right"><i class="ico-checkmark3 text-teal"></i></td>
                                                    <td>IDR <?php echo $data['harga_produk'];?></td>
                                                </tr>
                                                <tr>
                                                    <td width="20%" align="right"><i class="ico-checkmark3 text-teal"></i></td>
                                                ...
                                                <tr>
                                                    <td width="20%" align="right"><i class="ico-checkmark3 text-teal"></i></td>
                                                    <td>Stock : <?php echo $data['stok'];?></td>
                                                </tr>
                                                <tr>
                                                    <td width="20%" align="right"><i class="ico-checkmark3 text-teal"></i></td>
                                                    <td>Released on <?php echo $data['tgl_produk'];?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <!--/ table -->
