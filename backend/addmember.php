        ...
        <section id="main" role="main">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php
                        ...
                        include ("../conn/connection.php");
                            ...
                            if(isset($_POST['add'])){
                                ...
                                $query = mysqli_query($koneksi, "INSERT INTO tb_member values('','$user','$email','$pass','$address','$zip','$phone','$date')");
                    ...
                    <form class="panel panel-teal" action="" method="POST" data-parsley-validate>
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="ico-plus2 mr5"></i> Add Member</h3>
                        </div>               
