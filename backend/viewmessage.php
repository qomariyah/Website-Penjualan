        ...
        <section id="main" role="main">
            ...
            <div class="container-fluid">
                ...
                <?php
                    ...
                    $id = $_GET['id'];
                    $query = mysqli_query($koneksi, "SELECT * FROM tb_inbox where id_inbox='$id' ");

                    $data = mysqli_fetch_array($query);

                    $query = mysqli_query($koneksi, "UPDATE tb_inbox set sudahbaca = 'Y' ");
                ?>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-collapse pull out">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <ul class="list-table">
                                                <li style="width:70px;">
                                                    <img class="img-circle" src="../image/avatar/avatar.png" alt="" width="65px" height="65px">
                                                </li>
                                                <li class="text-left">
                                        ...
                                        <div class="panel-footer">
                                            <div class="panel-toolbar-wrapper">
                                                <div class="panel-toolbar">
                                                    <a href="message.php" class="btn btn-primary"><i class="ico-backward"></i> Back</a>
                                                </div>
                                                <div class="panel-toolbar text-right">
