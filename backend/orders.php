            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold">Orders</h4>
                    </div>
                </div>
                <!-- Page Header -->
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-teal">
                            <div class="panel-heading">
                                <h3 class="panel-title">Orders Management</h3>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-success" href="#.php?id=<?php echo $data['id_order']; ?>"><span class="glyphicon glyphicon-pencil"></span>  Edit</a> &nbsp; <a onclick="return confirm('Are you sure wanna delete this record?');" class="btn btn-danger" href="#.php?id=<?php echo $data['id_order']; ?>"><span class="glyphicon glyphicon-remove"></span>  Delete</a></td>
                                                </tr>
                                                <?php
                                                    $no++;
                                                }
