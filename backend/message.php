            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold">Message</h4>
                    </div>
                </div>
                <!-- Page Header -->
                                    ...
                                    <table class="table table-striped" id="zero-configuration">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td><?php echo $data['nama_inbox']; ?></td>
                                                    <td><?php echo $data['email_inbox']; ?></td>
                                                    <td><?php echo $data['pesan']; ?></td>
                                                    <td><a class="btn btn-primary" href="viewmessage.php?id=<?php echo $data['id_inbox']; ?>"><span class=" ico-search"></span>  View</a> &nbsp; <a onclick="return confirm('Are you sure wanna delete this record?');" class="btn btn-danger" href="deletemessage.php?id=<?php echo $data['id_inbox']; ?>"><span class="glyphicon glyphicon-remove"></span>  Delete</a></td>
                                                </tr>
                                                <?php
                                                    $no++;
                                                }
