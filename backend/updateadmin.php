            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold">Admin</h4>
                    </div>
                </div>
                <!-- Page Header -->
                    ...
                    <?php
                        ...
                        include ("../conn/connection.php");
                            ...
                            if(isset($_POST['update'])){
                                ...
                                $query = mysqli_query($koneksi, "UPDATE tb_admin set username_admin='$user', password_admin='$pass', alamat_admin='$address', email_admin='$email', telp_admin='$phone', level_admin='Admin' where id_admin='$id' ");
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3 mb10">
                                        <input name="user" type="text" class="form-control" placeholder="Username" required autofocus value="<?php echo $data['username_admin']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3 mb10">
                                        <input name="pass" type="password" class="form-control" placeholder="Password" required value="<?php echo $data['password_admin']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3 mb10">
                                        <input name="address" type="text" class="form-control" placeholder="Street Address" required value="<?php echo $data['alamat_admin']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3 mb10">
                                        <input name="email" type="email" class="form-control" placeholder="Email" required value="<?php echo $data['email_admin']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3 mb10">
                                        <input name="phone" type="text" class="form-control" placeholder="Phone Number" required value="<?php echo $data['telp_admin']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
