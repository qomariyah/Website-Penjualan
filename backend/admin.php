        ...
        <section id="main" role="main">
            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    ...
                    <div class="page-header-section">
                        <div class="toolbar">
                            <a href="addadmin.php"><button class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus"></span>  Add Admin</button></a>
                        </div>
                    </div>
                </div>
                <!-- Page Header -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-teal animation delay animating fadeInDown">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-success" href="updateadmin.php?id=<?php echo $data['id_admin']; ?>"><span class="glyphicon glyphicon-pencil"></span>  Edit</a> &nbsp; <a onclick="return confirm('Are you sure wanna delete this record?');" class="btn btn-danger" href="deleteadmin.php?id=<?php echo $data['id_admin']; ?>"><span class="glyphicon glyphicon-remove"></span>  Delete</a></td>
                                                </tr>
                                                <?php
                                                    $no++;
                                                }
