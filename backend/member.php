...
<html class="backend">
    ...
    <head>
        ...
        <title>Handmade's - backend</title>
        ...
        <section id="main" role="main">
            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    ...
                    <div class="page-header-section">
                        <div class="toolbar">
                            <a href="addmember.php"><button class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus"></span>  Add Member</button></a>
                        </div>
                    </div>
                </div>
                <!-- Page Header -->
                            ...
                            <div class="panel-collapse pull out">
                                    <table class="table table-striped" id="zero-configuration">
                                        ...
                                        <tbody>
                                            <?php
                                                include ("../conn/connection.php");
                                                $query = mysqli_query($koneksi, "SELECT * FROM tb_member ORDER BY id_member desc");
                                                $no = 1;
                                                while ($data = mysqli_fetch_array($query)) {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $data['alamat_member'];?> <?php echo $data['kode_pos']; ?></td>
                                                    <td><?php echo $data['telp_member']; ?></td>
                                                    <td><a class="btn btn-success" href="updatemember.php?id=<?php echo $data['id_member']; ?>"><span class="glyphicon glyphicon-pencil"></span>  Edit</a> &nbsp; <a onclick="return confirm('Are you sure wanna delete this record?');" class="btn btn-danger" href="deletemember.php?id=<?php echo $data['id_member']; ?>"><span class="glyphicon glyphicon-remove"></span>  Delete</a></td>
                                                </tr>
                                                <?php
                                                    $no++;
                                                }
