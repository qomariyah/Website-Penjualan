        ...
        <section id="main" role="main">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php
                        ...
                        include ("../conn/connection.php");
                            ...
                            if(isset($_POST['product_save'])){
                                ...
                                $query = mysqli_query ($koneksi, "INSERT INTO tb_produk values('','$product_name','$product_price','$product_category','$product_stock','$image','$product_desc','$date')");

                                move_uploaded_file($image_source, $path.$image);
                                ...
                                if ($query){
                                    ...
                                    <script type="text/javascript">
                                        setTimeout("location.href='product.php'", 500);
                                    </script>
                    ...
                    <form class="panel panel-teal" action="" method="POST" data-parsley-validate enctype="multipart/form-data">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="ico-plus2 mr5"></i> Add Product</h3>
                        </div>               
                        <div class="panel-body">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <div class="btn btn-primary btn-file">
                                                    <span class="icon iconmoon-file-3"></span> Browse <input type="file" name="image">
                                                </div>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3 mb10">
                                        <select class="form-control" id="selectize-customselect" name="category">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3 mb10">
                                        <textarea class="form-control" required placeholder="Description" name="desc"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel-footer"><center>
                            <input type="submit" name="product_save" class="btn btn-primary" value="Proceed">
