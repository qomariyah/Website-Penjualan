        ...
        <header id="header" class="navbar">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">
                    ...
                    <span class="text-warning">A</span> <!-- class : logo-text -->
                </a>
                <!--/ Brand -->
            </div>
            <!--/ END navbar header -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-success fade in">
                            ...
                            <h4 class="semibold">Welcome to <span class="text-primary">Handmade's</span> dashboard <?php echo $_SESSION['username'];?> !</h4>
                            <p class="mb10">You can see the latest activity from the website and you can also manage it here.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-xs-6">
                                <div class="table-layout animation delay animating fadeInDown">
                                    <div class="col-xs-4 panel bgcolor-info text-center">
                                        <div class="ico-cart2 fsize24"></div>
                                    </div>
                                    <div class="col-xs-8 panel">
                                        <div class="panel-body text-center">
                                            <h4 class="semibold nm">0</h4>
                                            <p class="semibold text-muted mb0 mt5 ellipsis"><a href="#">LATEST ORDER</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-xs-6">
                                <?php
                                    ...
                                    $result2 = mysqli_num_rows($query);
                                ?>

                                <div class="table-layout animation delay animating fadeInDown">
                                    <div class="col-xs-4 panel bgcolor-teal text-center">
                                        <div class="ico-tags2 fsize24"></div>
                                    </div>
                                    <div class="col-xs-8 panel">
                                        <div class="panel-body text-center">
                                            <h4 class="semibold nm"><?php echo $result2 ?></h4>
                                            <p class="semibold text-muted mb0 mt5 ellipsis"><a href="recent-product.php">PRODUCT RELEASE</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-xs-6">
                                ...
                                <div class="table-layout animation delay animating fadeInDown">
                                    ...
                                    <div class="col-xs-8 panel">
                                        <div class="panel-body text-center">
                                            <h4 class="semibold nm"><?php echo $result3 ?></h4>
                                            <p class="semibold text-muted mb0 mt5 ellipsis"><a href="recent-member.php">REGISTERED MEMBERS</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-xs-6">
                                <?php
                                    include ("../conn/connection.php");
                                    $date = date('Y-m-d');
                                    $query = mysqli_query($koneksi, "SELECT * FROM tb_inbox");
                                    $result4 = mysqli_num_rows($query);
                                ?>
                                <div class="table-layout animation delay animating fadeInDown">
                                    <div class="col-xs-4 panel bgcolor-primary text-center">
                                        <div class="ico-inbox fsize24"></div>
                                    </div>
                                    <div class="col-xs-8 panel">
                                        <div class="panel-body text-center">
                                            <h4 class="semibold nm"><?php echo $result4 ?></h4>
                                            <p class="semibold text-muted mb0 mt5 ellipsis"><a href="recent-message.php">DIRECT MESSAGES</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
